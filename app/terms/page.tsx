        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-blue max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-[#374151] leading-relaxed mb-4">
                ...
                retain ownership of the data and proposals you create using our Service, but grant us a license to use,
            ...
            <section>
              ...
              <p className="text-[#374151] leading-relaxed mb-4">
                ...
                calculations and projections are estimates based on available data and should be verified independently.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-[#374151] leading-relaxed mb-4">
                We reserve the right to suspend or terminate your account and access to the Service at any time, without
                notice, for violation of these Terms or any other reason. Upon termination, you must cease all use of
                the Service. You may cancel your subscription at any time through your account settings.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-[#374151] leading-relaxed mb-4">
                ...
                arising from these Terms or the Service shall be subject to the exclusive jurisdiction of the courts in
          ...
          <div className="mt-12 pt-8 border-t border-[#E5E7EB]">
            <p className="text-sm text-[#6B7280] text-center">
              By using Sunkode, you acknowledge that you have read, understood, and agree to be bound by these Terms and
              Conditions.
            </p>
          </div>
        </div>
